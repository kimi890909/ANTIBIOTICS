...
<head>
    ...
    <title>義大醫療體系抗生素使用智能決策系統 V01 (存檔版)</title>
...
<body class="min-h-screen flex flex-col p-4">
    ...
    <header class="mb-6 mt-4">
        <div class="max-w-4xl mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center gap-2 text-xs bg-[#FFF3E0] text-[#E65100] px-3 py-1.5 rounded-full border border-[#FFE0B2]">
    ...
    <script>
        const app = (function() {
            ...
            const DB = [
                ...
                { DrugName: "Cefepime 2g/vial", Category: "CCR", CCR_Min: 30, CCR_Max: 5
